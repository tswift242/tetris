...
public class TetrisAppletPanel extends JPanel
{
	...
	private int startX, startY, moveY, blockWidth, blockHeight, rows, columns, boardWidth, boardHeight, score;
	private boolean startOfGame, colLeft, colRight, colDown, ableToRotate, onTopOfBlockR, paused, musicOn, newGame, GAMEOVERflag;
	...
	public TetrisAppletPanel ()
	{
		...
		try
		{
			url1 = new URL ("file", "localhost", "Final Fantasy Theme.wav");
		}
	...
	public void paintComponent (Graphics page)
	{
		...
		if ((score == 1000) || (score == 2000) || (score == 5000) || (score == 10000) || (score == 15000))
			speedIncrease();
